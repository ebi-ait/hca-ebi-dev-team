...
Any one-off scripts that doen't have a dedicated location should be maintained in the [scripts](scripts/) directory. See the readme there for more instructions.
