...
Below you can find an example of a project, and how the entities relate to each other: you can click on each of the 
entities to be redirected to the folder of the metadata schema in that contains all the type entities of that class.
