...
cell_types <- read_xlsx("~/Google Drive File Stream/Shared drives/AIT/HCA - Wrangler tasks/r-Release/Cell type annotations/celltypes_annotated_harmonized_v3.xlsx",
