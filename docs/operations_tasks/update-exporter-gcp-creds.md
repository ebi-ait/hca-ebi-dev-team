...
1. Run integration tests in prod

    (The ingest-to terra test doesn't run in prod, but it would be nice to run it and be able to delete any test project ) See ticket [ebi-ait/dcp-ingest-central#699](https://github.com/ebi-ait/dcp-ingest-central/issues/699)
